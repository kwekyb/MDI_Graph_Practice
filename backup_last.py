...
class MainWindow(QMainWindow):
    ...
    def plot_data_custom(self):
        """사용자 입력 데이터를 기반으로 온도, 습도, 이슬점을 각각의 별도 그래프로 그리는 함수 (평균값 보조선 포함)"""
        ...
        # 이슬점 값들을 안전하게 숫자로 변환 (변환 불가능한 값은 np.nan 처리)
        dew_points_numeric = []
        ...
        # np.nanmean을 사용하여 nan을 무시한 평균값 계산
    ...
    def showGraph(self):
        """그래프 보기 버튼 클릭 시 숨겨진 그래프 영역을 보여주고, 그래프를 갱신하는 함수"""
